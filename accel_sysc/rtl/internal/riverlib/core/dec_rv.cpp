...
void DecoderRv::generateVCD(sc_trace_file *i_vcd, sc_trace_file *o_vcd) {
    ...
    if (o_vcd) {
        ...
        sc_trace(o_vcd, r.csr_addr, pn + ".r.csr_addr");
...
void DecoderRv::comb() {
    ...
    o_unsigned_op = r.unsigned_op.read();
    o_rv32 = r.rv32.read();
    o_f64 = r.f64.read();
    o_compressed = r.compressed.read();
    o_amo = r.amo.read();
