...
pcie_dma::pcie_dma(sc_module_name name,
    ...
    reqfifo->i_wr(i_pcie_dmai.read().valid);
    ...
    respfifo->i_rd(i_pcie_dmai.read().ready);
...
void pcie_dma::generateVCD(sc_trace_file *i_vcd, sc_trace_file *o_vcd) {
    ...
    if (o_vcd) {
        ...
        sc_trace(o_vcd, r.dw0, pn + ".r_dw0");
        sc_trace(o_vcd, r.dw1, pn + ".r_dw1");
        sc_trace(o_vcd, r.dw2, pn + ".r_dw2");
        sc_trace(o_vcd, r.dw3, pn + ".r_dw3");
        sc_trace(o_vcd, r.req_rd_locked, pn + ".r_req_rd_locked");
        sc_trace(o_vcd, r.xlen, pn + ".r_xlen");
        sc_trace(o_vcd, r.xsize, pn + ".r_xsize");
        sc_trace(o_vcd, r.xaddr, pn + ".r_xaddr");
        sc_trace(o_vcd, r.xwstrb, pn + ".r_xwstrb");
        sc_trace(o_vcd, r.xwdata, pn + ".r_xwdata");
        sc_trace(o_vcd, r.xwena, pn + ".r_xwena");
        sc_trace(o_vcd, r.xrdata, pn + ".r_xrdata");
        sc_trace(o_vcd, r.xerr, pn + ".r_xerr");
        sc_trace(o_vcd, r.resp_with_payload, pn + ".r_resp_with_payload");
        sc_trace(o_vcd, r.resp_data, pn + ".r_resp_data");
        sc_trace(o_vcd, r.resp_status, pn + ".r_resp_status");
        sc_trace(o_vcd, r.resp_cpl, pn + ".r_resp_cpl");
        sc_trace(o_vcd, r.byte_cnt, pn + ".r_byte_cnt");
    }
