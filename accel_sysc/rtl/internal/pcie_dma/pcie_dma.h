...
SC_MODULE(pcie_dma) {
 ...
 private:
    ...
    static const uint8_t TLP_FMT_3DW_NOPAYLOAD = 0;
    static const uint8_t TLP_FMT_4DW_NOPAYLOAD = 1;
    static const uint8_t TLP_FMT_3DW_PAYLOAD = 2;
    static const uint8_t TLP_FMT_4DW_PAYLOAD = 3;
    // 
    // TLP Completion Status
    static const uint8_t TLP_STATUS_SUCCESS = 0;
    static const uint8_t TLP_STATUS_UNSUPPORTED = 1;
    static const uint8_t TLP_STATUS_ABORTED = 4;
    // 
