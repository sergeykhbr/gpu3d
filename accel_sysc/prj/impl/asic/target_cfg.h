...
static const int CFG_ILOG2_LINES_PER_WAY = 2;               // I$ length: 7=16KB; 8=32KB; ..
static const int CFG_ILOG2_NWAYS = 2;                       // I$ associativity. Default bits width = 2, means 4 ways

static const int CFG_DLOG2_LINES_PER_WAY = 2;               // D$ length: 7=16KB; 8=32KB; ..
...
static const int CFG_L2CACHE_ENA = 0;
...
static const int CFG_BOOTROM_LOG2_SIZE = 15;                // 16=64 KB (default); 17=128KB; ..

// Project relative HEX-file name to init boot ROM without .hex extension:
static const std::string CFG_BOOTROM_FILE_HEX = "../../../software/bootrom/bin/bootrom";

// Internal SRAM block:
//     - Increase memory map if need > 2MB FU740
//     - Change bootloader stack pointer if need less than 512 KB
static const int CFG_SRAM_LOG2_SIZE = 16;                   // 19=512 KB (KC705); 21=2 MB (ASIC); ..
